...
public class EmployeeInfoUsingPair {
	...
	public static void main(String[] args) {
		...
		EmployeeInfoUsingPair ei = new EmployeeInfoUsingPair();
		ei.sort(emps, EmployeeInfoUsingPair.SortMethod.BYNAME);
		System.out.println(emps);
		//same instance
		ei.sort(emps, EmployeeInfoUsingPair.SortMethod.BYSALARY);
		System.out.println(emps);
	}
}
